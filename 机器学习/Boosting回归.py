# -*- coding: utf-8 -*-
"""
Created on Sat Apr  6 16:38:41 2024
...
# 读取excel数据
data = pd.read_excel("E:\Programs\Gitprojects\VisualizationTeamwork\机器学习\数据汇总.xlsx")
print(data)
...
val_data_with_predictions.to_excel("E:\Programs\Gitprojects\VisualizationTeamwork\机器学习\测试集预测结果.xlsx", index=False)